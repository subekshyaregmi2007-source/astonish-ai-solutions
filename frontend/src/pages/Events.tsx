                      ...
                      >
                        ...
                        <div className="py-8 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 px-0">
                          ...
                          <div className="md:col-span-3 flex items-start md:justify-end">
                            <a 
                              href="/contact"
                              className="px-7 py-3 border border-[#2E8B57] text-[#2E8B57] text-[11px] font-semibold uppercase tracking-[0.2em] hover:bg-[#2E8B57] hover:text-white transition-colors inline-block text-center"
                            >
                              Register
                            </a>
                          </div>
