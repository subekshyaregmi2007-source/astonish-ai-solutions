      ...
      <PageTransition>
        ...
        <section className="relative flex flex-col justify-center min-h-screen px-6 md:px-16 overflow-hidden grain-overlay">
          ...
          <motion.div className="absolute bottom-0 left-0 right-0 border-t border-[#AECFBE]"
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-16 py-3 hidden lg:grid grid-cols-4 gap-6">
        ...
        <div className="select-none" style={{ background: "#F4FBF6" }}>
          <div className="flex items-stretch">
            ...
            {/* Fixed left label */}
            <div className="shrink-0 flex items-center px-8 md:px-14 py-4 gap-3">
              <motion.span className="w-2 h-2 bg-[#2E8B57] rounded-full inline-block"
                animate={{ opacity: [1, 0.3, 1] }} transition={{ duration: 2.4, repeat: Infinity }} />
              <span className="text-[12px] font-semibold uppercase tracking-[0.28em] text-[#3D6B52] whitespace-nowrap">
                Trusted by
              </span>
            </div>
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center shrink-0">
                        <div className="flex items-center gap-4 px-8 py-4">
                          <div className="w-9 h-9 rounded-full bg-[#D8EDE0] flex items-center justify-center shrink-0">
                            <span className="text-[11px] font-bold text-[#2E8B57] tracking-wide">
                              {client.initials}
                            </span>
                          </div>
                          <span className="text-[15px] font-medium text-[#1A3326] whitespace-nowrap tracking-tight">
                            {client.name}
                          </span>
                        </div>
                        <span className="w-[4px] h-[4px] rounded-full bg-[#AECFBE] shrink-0 mx-2" />
                      </div>
                    ))}
                  </div>
                ))}
          ...
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="pt-6 border-t border-[#AECFBE]">
              <div className="flex items-center justify-between">
                ...
                <Link href="/admin" className="text-[10px] text-[#3D6B52] hover:text-[#2E8B57] transition-colors opacity-50 hover:opacity-100">
                  Admin
                </Link>
              </div>
            </div>
