...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    response:
      "We offer six core solutions:\n\n1. **AI-Powered Virtual Assistant** — 24/7 intelligent support with seamless human handoff\n2. **Predictive Issue Resolution** — detect and fix problems before employees notice\n3. **Intelligent Workflow Automation** — automate repetitive processes with AI decision nodes\n4. **Digital Experience Analytics** — real-time insights into employee experience health\n5. **AI Prototyping Studio** — go from concept to working prototype in days\n6. **Secure Knowledge Management** — AI-powered search across your organisation's knowledge\n\nVisit our Solutions page to learn more!",
  },
  {
  ...
  {
    patterns: [/prototype|studio|prototype studio|rapid/i],
    response:
  ...
  },
  {
    ...
    response:
      "Our NHS Digital transformation project is one of our proudest achievements. We deployed an AI-powered virtual assistant across 12 NHS trusts, handling over 40,000 monthly employee IT queries and reducing resolution time from 48 hours to under 4 minutes — saving £2.3M annually.",
  },
  {
  ...
  },
  {
    ...
    response:
      "We worked with RetailMax to deploy AI knowledge management and virtual assistant support across 500+ retail locations. Staff can now instantly access product, policy, and troubleshooting information — cutting customer resolution time by 62%.",
  },
  {
    patterns: [/university|education|school|student/i],
    response:
      "For the EduLearn Consortium, we built an AI-powered digital experience platform serving 50,000 students and staff across 15 UK universities — unifying IT support, HR queries, and administrative processes with a 91% first-contact resolution rate.",
  },
  {
    patterns: [/testimonial|review|feedback|what (do|did) (clients|customers) (say|think)/i],
    response:
      "Our clients consistently rate us 5 stars. Dr. Sarah Mitchell (NHS Digital CDO) said: \"This is what the future of public sector digital transformation looks like.\" James Okonkwo (VP Technology, Global Bank Corp) added: \"The ROI speaks for itself.\" Visit our Testimonials page to read all client stories.",
  },
  {
    patterns: [/event|conference|summit|workshop|meetup/i],
    response:
      "We have two major upcoming events:\n\n• **AI-Solutions Annual Innovation Summit 2024** — September 15, Sunderland Civic Centre. 500+ technology leaders, keynotes, workshops, and live demos. Theme: The Human-AI Partnership.\n\n• **Enterprise AI Bootcamp — London** — October 3, The Shard. Intensive two-day bootcamp for enterprise technology teams.\n\nVisit our Events page to see all past and upcoming events.",
  },
  {
    patterns: [/summit|innovation summit/i],
    response:
      "Our Annual Innovation Summit 2024 is on September 15 at Sunderland Civic Centre. It brings together 500+ technology leaders, AI researchers, and enterprise innovators for two days of keynotes, workshops, and live demos. This year's theme is The Human-AI Partnership.",
  },
  {
    patterns: [/article|news|blog|insight|read|publication/i],
    response:
      "We publish regular thought leadership and company news. Recent highlights include:\n\n• \"How AI is Reshaping the Digital Employee Experience in 2024\"\n• \"The ROI of AI: What Our Clients Are Actually Achieving\"\n• \"Building the Future: AI-Solutions Opens Sunderland Innovation Lab\"\n\nVisit our Articles page to read the full library.",
  },
  {
    patterns: [/roi|return|saving|cost|value|investment/i],
    response:
      "Across 20 enterprise deployments, our clients achieve:\n\n• Average payback period: **7.2 months**\n• IT support cost reduction: **64% average**\n• Employee satisfaction improvement: **+38 percentage points**\n• Unplanned downtime reduction: **71% average**\n\nThe fastest ROI comes from focused use cases, rigorous baseline measurement, and strong executive sponsorship.",
  },
  {
    patterns: [/contact|get in touch|reach|speak|talk|email|phone|enquir|inquir/i],
    response:
      "You can reach us through our Contact page, where you can fill in your name, email, phone, company, country, job title, and project details. Our team will get back to you promptly.\n\nWe're based in Sunderland, UK and work with clients worldwide.",
  },
  {
    patterns: [/demo|demonstration|trial|try|pilot/i],
    response:
      "We'd love to show you AI-Solutions in action! Head to our Contact page and submit an inquiry — just mention you'd like a personalised demo in the job details field. Our team will arrange a tailored demonstration based on your industry and use case.",
  },
  {
    patterns: [/price|pricing|cost|how much|fee|subscription|licens/i],
    response:
      "Our pricing is tailored to each organisation's scale, industry, and requirements. The best way to get accurate pricing is to contact us through our Contact page with your project details — our team will put together a proposal that fits your needs and budget.",
  },
  {
    patterns: [/where|location|office|based|sunderland/i],
    response:
      "AI-Solutions is headquartered in Sunderland, UK — part of the growing North East technology hub. We also recently opened our Sunderland Innovation Lab, a 12,000 square foot research facility housing 40 researchers and data scientists. We serve clients globally across Europe, North America, Asia, and Africa.",
  },
  {
    patterns: [/lab|research|r&d|innovation lab/i],
    response:
      "We recently opened the AI-Solutions Innovation Lab in Sunderland — a 12,000 sq ft facility with 40 researchers and engineers. Key areas include advanced natural language understanding, multimodal AI, federated learning, and explainable AI. We also have a dedicated ethics review board for all systems we develop.",
  },
  {
    patterns: [/award|recognition|gartner|deloitte|accolade/i],
    response:
      "We've received significant industry recognition:\n\n• **UK Tech Innovation Award 2024** — Enterprise AI Solutions category\n• **Gartner Cool Vendor** in Digital Employee Experience\n• **Deloitte Fast 50** — one of the UK's fastest-growing technology companies\n\nThree major industry awards in 2024 alone.",
  },
  {
    patterns: [/safe|secure|privacy|gdpr|data|complian/i],
    response:
      "Security and compliance are core to everything we build. Our Knowledge Management system includes full access controls, and our AI development follows rigorous ethical assessment through our Innovation Lab's dedicated ethics review board. We work with regulated industries including NHS and financial services, so data protection is fundamental to our architecture.",
  },
  {
...
function getResponse(input: string): string {
  ...
  return "I'm not sure I have the answer to that specific question, but our team would love to help! You can reach us through the Contact page — just fill in your details and our experts will get back to you. You can also explore our Solutions, Industries, or Articles pages for more information.";
}
...
function formatText(text: string) {
  ...
  return lines.map((line, i) => {
    ...
    return (
      <span key={i} dangerouslySetInnerHTML={{ __html: bold + (i < lines.length - 1 ? "<br/>" : "") }} />
    );
  });
}
...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#111827] text-white flex items-center justify-center shadow-lg hover:bg-[#1f2937] transition-colors"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[360px] max-h-[520px] bg-white border border-gray-200 rounded-2xl shadow-xl flex flex-col overflow-hidden"
            data-testid="panel-chat"
          >
            {/* Header */}
            <div className="bg-[#111827] text-white px-5 py-4 flex items-center gap-3 shrink-0">
              <div className="w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center">
                <Bot className="w-4 h-4" />
              </div>
              <div>
                <div className="font-semibold text-sm">AI-Solutions Assistant</div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-gray-50">
              {messages.map((msg) => (
                ...
                >
                  <div className={`w-7 h-7 rounded-full shrink-0 flex items-center justify-center ${msg.role === "assistant" ? "bg-indigo-100 text-indigo-600" : "bg-[#111827] text-white"}`}>
            ...
            <div className="px-4 py-3 border-t border-gray-100 bg-white flex items-center gap-2 shrink-0">
              <input
                ...
                className="flex-1 text-sm px-3 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-gray-50"
                data-testid="input-chat"
              />
              <button
                onClick={sendMessage}
                disabled={!input.trim() || typing}
                className="w-9 h-9 rounded-lg bg-[#111827] text-white flex items-center justify-center hover:bg-[#1f2937] disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0"
