...
const inputClass = "w-full bg-[#0d0d0d] border border-[#262626] text-[#e5e2e1] placeholder-[#6b7280] h-11 px-4 text-sm focus:outline-none focus:border-[#6ee7b7] transition-colors";
const textareaClass = "w-full bg-[#0d0d0d] border border-[#262626] text-[#e5e2e1] placeholder-[#6b7280] px-4 py-3 text-sm focus:outline-none focus:border-[#6ee7b7] transition-colors resize-y min-h-[120px]";
const labelClass = "text-[10px] font-semibold uppercase tracking-[0.2em] text-[#a8c4b0]";
      ...
      <PageTransition>
        <div className="pt-24 md:pt-28 pb-16 md:pb-24 px-6 md:px-16 max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 items-start">
            {/* Left */}
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-[#6ee7b7] mb-4">Contact</p>
              <h1 className="text-[40px] md:text-[56px] font-extralight tracking-[-0.03em] text-[#e5e2e1] leading-none mb-6">
                Let's Talk Future.
              </h1>
              <p className="text-[#a8c4b0] text-base leading-relaxed mb-10">
              ...
              <div className="border-t border-[#262626]">
                <div className="border-b border-[#262626] py-6">
                  <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#a8c4b0] mb-1.5">Global Headquarters</div>
                  <div className="text-[#e5e2e1]">Sunderland, UK</div>
                </div>
                <div className="border-b border-[#262626] py-6">
                  <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#a8c4b0] mb-1.5">Email</div>
