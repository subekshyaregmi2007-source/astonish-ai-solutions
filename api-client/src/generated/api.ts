...
/**
 * @summary Update an inquiry (admin)
 */
...
export const getUpdateInquiryMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInquiry>>, TError,{id: number;data: BodyType<InquiryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateInquiry>>, TError,{id: number;data: BodyType<InquiryInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateInquiry>>, {id: number;data: BodyType<InquiryInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateInquiryMutationBody = BodyType<InquiryInput>
 ...
 */
export const deleteInquiry = async (id: number, options?: RequestInit): Promise<DeleteInquiry200> => {

  return customFetch<DeleteInquiry200>(getDeleteInquiryUrl(id),
  {
    ...options,
    method: 'DELETE'
